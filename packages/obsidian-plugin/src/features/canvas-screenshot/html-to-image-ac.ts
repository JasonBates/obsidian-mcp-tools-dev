// @ts-nocheck
// AC bundled html-to-image - uses toArray(sourceStyle) which properly captures SVG properties
// Unlike npm html-to-image which caches properties from document.documentElement
